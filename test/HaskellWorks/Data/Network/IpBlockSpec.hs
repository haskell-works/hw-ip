...
spec = describe "HaskellWorks.HUnit.IpSpec" $ do
  describe "IpBlock" $ do
    ...
    it "should implement read" $ requireTest $ do
      read "1:2:3:4::/127"  === V.IpBlockV6 (V6.IpBlock (V6.IpAddress (0x10002    , 0x30004 , 0, 0)) (V6.IpNetMask 127))
      read "1234::/16"      === V.IpBlockV6 (V6.IpBlock (V6.IpAddress (0x12340000 , 0       , 0, 0)) (V6.IpNetMask  16))
      read "12:34::/32"     === V.IpBlockV6 (V6.IpBlock (V6.IpAddress (0x120034   , 0       , 0, 0)) (V6.IpNetMask  32))
