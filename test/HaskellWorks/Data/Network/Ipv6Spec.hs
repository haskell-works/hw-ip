...
spec = describe "HaskellWorks.HUnit.IpSpec" $ do
  describe "Ipv6Block" $ do
    ...
    it "should implement firstAddress/lastAddress" $ require $ property $ do
      (firstAddress $ IpBlock (Left  $ Ipv4Block (Ipv4Address   0xff000000) (Ipv4NetMask  8)))  === (0, 0, 0xFFFF, 0xFF000000)
      (firstAddress $ IpBlock (Right $ Ipv6Block (Ipv6Address (4, 4, 0, 0)) (Ipv6NetMask 33)))  === (4, 4, 0, 0)
      (lastAddress  $ IpBlock (Left  $ Ipv4Block (Ipv4Address   0xff000000) (Ipv4NetMask  8)))  === (0 , 0 , 0xFFFF , 0xFFFFFFFF)
      (lastAddress  $ IpBlock (Right $ Ipv6Block (Ipv6Address (4, 4, 0, 0)) (Ipv6NetMask 33)))  === (4 , 0x7FFFFFFF , 0xFFFFFFFF , 0xFFFFFFFF)
